...
-- Tiempo de generación: 08-11-2021 a las 17:00:05
...
--
-- Estructura de tabla para la tabla `images_informe_freezer`
--

CREATE TABLE `images_informe_freezer` (
...
--
-- Indices de la tabla `images_informe_freezer`
--
ALTER TABLE `images_informe_freezer`
...
--
-- AUTO_INCREMENT de la tabla `images_informe_freezer`
--
ALTER TABLE `images_informe_freezer`
