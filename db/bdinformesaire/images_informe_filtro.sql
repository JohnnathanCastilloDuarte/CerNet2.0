...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2022 a las 17:13:23
...
(1, 2, 'imagenes/2/1Primera.jpg', NULL, 'Primera', '2022-02-14 15:04:24');
...
--
ALTER TABLE `images_informe_filtro`
  MODIFY `id_imagen` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id principal de esta tabla', AUTO_INCREMENT=2;
COMMIT;
