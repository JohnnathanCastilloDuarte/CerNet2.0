...
-- Tiempo de generación: 08-11-2021 a las 16:59:43
...
--
-- Estructura de tabla para la tabla `informe_freezer`
--

CREATE TABLE `informe_freezer` (
  `id_informe_freezer` int(11) NOT NULL COMMENT 'id principal de la tabla',
  ...
  `tipo` int(2) DEFAULT NULL COMMENT '0 TEM 1 HUM',
  `id_mapeo` int(11) DEFAULT NULL COMMENT 'id  de la tabla freezer sensor',
...
--
-- Indices de la tabla `informe_freezer`
--
ALTER TABLE `informe_freezer`
  ADD PRIMARY KEY (`id_informe_freezer`);
...
--
-- AUTO_INCREMENT de la tabla `informe_freezer`
--
ALTER TABLE `informe_freezer`
  MODIFY `id_informe_freezer` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id principal de la tabla';
COMMIT;
