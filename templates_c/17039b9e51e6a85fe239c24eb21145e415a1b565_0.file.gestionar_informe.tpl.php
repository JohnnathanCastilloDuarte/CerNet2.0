...
function content_627ac213e0c016_48182086 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="row">
	<div class="col-sm-12">
		<div class="card">
						...
						<div class="card">
							...
							<div class="card-body">
								<table class="table">
									...
									<tbody>
										<?php if ($_smarty_tpl->tpl_vars['conteo_mapeo_sala_limpia']->value == 0) {?>
										<tr>
											<td colspan="4">
												<h6>
													Sin resultados
										...
										<?php } else { ?>
										<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['array_mapeo_sala_limpia']->value, 'mapeo');
if ($_from !== null) {
