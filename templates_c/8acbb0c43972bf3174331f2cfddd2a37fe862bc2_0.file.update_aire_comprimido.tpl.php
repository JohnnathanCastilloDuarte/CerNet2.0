<?php
/* Smarty version 3.1.34-dev-7, created on 2022-03-31 15:43:47
  from 'C:\xampp\htdocs\CerNet2.0\templates\item\update_aire_comprimido.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6245b01311f497_90185371',
...
function content_6245b01311f497_90185371 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="row">
	<div class="col-sm-12">

	<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['array_aire_comprimido']->value, 'aire_comprimido');
if ($_from !== null) {
...
?>
		<div class="card">
			...
			<div class="card-body">
				<input type="hidden" name="" id="id_aire_comprimido" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['id_aire_comprimido'];?>
">
...
">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<input type="text" name="" id="nombre_sala" class="form-control" placeholder="nombre sala" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['nombre_sala'];?>
">
					</div>
					<div class="col-sm-4">
						<label>Área</label>
						<input type="text" name="" id="area" class="form-control" placeholder="Área" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['area'];?>
">
					</div>
					<div class="col-sm-4">
						<label>Punto de uso de aire comprimido</label>
						<input type="text" name="" id="punto_aire_comprimido" class="form-control" placeholder="Punto de aire comprimido" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['punto_uso_aire_comprimido'];?>
">
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-sm-6">
						...
						<input type="text" name="" id="codigo_punto" class="form-control" placeholder="Código del punto" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['codigo_punto'];?>
">
					</div>
					<div class="col-sm-6">
						<label>Grado ISO 8573-1</label>
						<input type="text" name="" id="grado_iso" class="form-control" placeholder="Grado de ISO 8573-1" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['grado_iso'];?>
">
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-sm-6">
						...
						<input type="text" name="" id="direccion_aire_comprimido" class="form-control" placeholder="Código del punto" value="<?php echo $_smarty_tpl->tpl_vars['aire_comprimido']->value['direccion'];?>
">
					</div>
				</div>
				<br>
