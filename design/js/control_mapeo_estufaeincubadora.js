...
(function(){
	...
	$(document).on('click','#eliminar_informe_estufaeincubadora',function(){
		...
		Swal.fire({
			...
			if(result.value){
				...
				$.ajax({
					type:'POST',
					data:{id_informe},
					url:'templates/estufaeincubadora/eliminar_informe.php',
					success:function(response){
						...
						if(response == "Si"){
							...
							alert("error al eliminar contacta con el administrador")
						}
					}
				});
			}
...
///////////////ACTUALIZA LOS COMENTARIOS DEL IFNORME
(function(){
	
	$(document).on('submit','#form_2_estufaeincubadora',function(e){
	e.preventDefault();
	$.ajax({
		url: 'templates/estufaeincubadora/actualizar_informe_parte1.php',
    	type: 'POST',
    	dataType: 'html',
...
(function(){
	...
	$(document).on('submit','#form_1_estufaeincubadora',function(e){
	e.preventDefault();
	$.ajax({
		url: 'templates/estufaeincubadora/actualizar_informe_parte1.php',
    	type: 'POST',
...
function setear_campos_estufaeincubadora(){
    ...
    $("#nombre_mapeo_estufaeincubadora").val(0);
	$("#nombre_mapeo_eleccion").val("");
...
$(document).on('click','#modificar_mapeo_creada_estufaeincubadora',function(){
	...
	$.ajax({
		...
		success:function(e){
			...
			$("#nombre_mapeo_estufaeincubadora").val(traer.nombre)
...
$(document).on('click','#btn_setear_campos', function(){
