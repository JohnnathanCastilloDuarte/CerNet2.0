...
class MYPDF extends TCPDF 
{
	...
	//	$this->writeHTMLCell(70, 15, 125, 7, 'Informe: '.$nombre_informe.' <br>'.$numot.' // REVISION: 0.0.0', 1, 0, 0, true, 'C', true);
    	...
    	$this->MultiCell(115, 10, $a, 1, 'C', 0, 0, 20, 30, true, 0, false, true, 14, 'M');
    	$this->MultiCell(115, 1, 'CALIFICACIÓN CUARTO FRÍO RECEPCIÓN DIAGNÓSTICA CF-01', 1, 'C', 0, 0, 20, 40, true, 0, false, true, 8, 'M');

		$this->writeHTMLCell(55, 10, 135, 30,'&nbsp;'.$nombre_informe.' <br> Versión: 01', 1, 0, 0, true, 'M', true);

		$this->writeHTMLCell(55, 6, 135, 40, '&nbsp;Página '.$this->getAliasNumPage().' de '.$this->getAliasNbPages(), 1,0,0,true,'M', true);
