...
$id_asignado = $_GET['asignado'];
	...
	$buscar_informacion = mysqli_prepare($connect,"SELECT b.id_item, c.presion_sala,c.especificacion_1_temp,c.especificacion_2_temp, c.especificacion_1_hum,c.especificacion_2_hum, c.lux, c.ruido_dba,c.ren_hr
    ...
    mysqli_stmt_bind_result($buscar_informacion, $id_item, $presion_sala, $especificacion_1_temp, $especificacion_2_temp,$especificacion_1_hum, $especificacion_2_hum, $lux, $ruido_dba,$ren_hr);
