...
$nombre_imagen = $_FILES["imagen"]["name"]['type'];

$var = $_FILES["imagen"]["type"];
...
if ($pasaimagen == 'SI') {
        ...
        do {
            ...
            if(mysqli_stmt_num_rows($consultar) > 0){
                ...
                $creando_imagen = mysqli_prepare($connect,"INSERT INTO image_sala_limpia (id_asignado, url, tipo, nombre) VALUES (?,?,?,?)");
