...
<form id="formulario">        
<input type="text" value="{$id_asignado_aire}" id="id_asignado_aire" name="id_asignado_aire">   
...
<script type="text/javascript" src="design/js/control_mapeo_aire_comprimido.js"></script>
