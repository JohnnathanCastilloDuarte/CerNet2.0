...
// 1-CONSULTAR LA INFORMACIÓN LA CUAL SE IMPRIMIRA EN LAS CABECERAS Y EL NOMBRE DEL INFORME
		...
		$query_1 = mysqli_prepare($connect,"SELECT nombre, id_asignado, id_mapeo, concepto, observacion, comentarios, fecha_registro FROM informe_refrigerador WHERE id_informe_refrigerador = ?");
    ...
    $a = "PRUEBA DE MAPEO TERMICO A ".$nombre_item;
    ...
    $query_7 = mysqli_prepare($connect,"SELECT  valor_seteado_temperatura, temperatura_minima, temperatura_maxima FROM refrigerador_mapeo WHERE id_mapeo = ?");
    ...
    $fecha_inicio_mapeo = mysqli_prepare($connect,"SELECT fecha_inicio, hora_inicio FROM refrigerador_mapeo WHERE  id_asignado = ? ORDER BY fecha_inicio ASC limit 1");
    ...
    $fecha_fin_mapeo = mysqli_prepare($connect,"SELECT fecha_final, hora_final FROM refrigerador_mapeo WHERE  id_asignado = ? ORDER BY fecha_inicio DESC limit 1");
...
//CONSULTAR MAPEOS 
 ...
 $query_8 = mysqli_prepare($connect,"SELECT a.id_mapeo, a.nombre, a.temperatura_maxima, a.temperatura_minima FROM refrigerador_mapeo as a, refrigerador_datos_crudos as b, refrigerador_sensor as c 
                                      WHERE a.tipo_mapeo != 3 AND a.id_asignado = ? AND a.informe_base > 0 AND b.id_refrigerador_sensor = c.id_refrigerador_sensor GROUP BY a.id_mapeo, a.nombre, a.temperatura_maxima, a.temperatura_minima ");
 ...
 while($row = mysqli_stmt_fetch($query_8)){
  ...
  $query_apoyo_0 = mysqli_prepare($connect,"SELECT AVG(CAST(a.temperatura AS DECIMAL(6,2))) as promedio FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, sensores as d 
...
$query_9 = mysqli_prepare($connect,"SELECT ubicacion FROM images_informe_refrigeradores WHERE id_informe = $id_informe AND tipo_imagen = 1");
...
$query_9 = mysqli_prepare($connect,"SELECT DISTINCT a.nombre, b.nombre, a.serie, a.id_sensor  FROM sensores as a, bandeja as b, refrigerador_sensor as c, refrigerador_mapeo as d 
...
$pdf->writeHTML($html_10, true,false,false,false,'');
 ...
 $query_11 = mysqli_prepare($connect,"SELECT a.id_mapeo, a.nombre, a.temperatura_maxima, a.temperatura_minima, a.fecha_inicio, a.hora_inicio,
                                      ...
                                      refrigerador_mapeo as a, refrigerador_datos_crudos as b, refrigerador_sensor as c WHERE 
                                      a.id_asignado = ? AND a.informe_base > 0 AND b.id_refrigerador_sensor = c.id_refrigerador_sensor 
...
$query_11_1 = mysqli_prepare($connect,"SELECT DISTINCT MAX(CAST(a.temperatura AS DECIMAL(6,2))) as maximo, a.time FROM refrigerador_datos_crudos as a, refrigerador_sensor as b 
WHERE b.id_asignado = ? AND a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ?
GROUP BY a.time");
...
$query_12 = mysqli_prepare($connect,"SELECT a.nombre, a.n_increment, b.nombre FROM informe_refrigerador as a, refrigerador_mapeo as b WHERE a.id_asignado = ?
...
$consulta_tabla = mysqli_prepare($connect,"SELECT a.id_mapeo, a.nombre, a.temperatura_maxima, a.temperatura_minima, a.fecha_inicio, a.hora_inicio,
                                      ...
                                      refrigerador_mapeo as a, refrigerador_datos_crudos as b, refrigerador_sensor as c WHERE a.id_mapeo != 3 AND
                                      a.id_asignado = ? AND a.informe_base > 0 AND b.id_refrigerador_sensor = c.id_refrigerador_sensor 
...
;
	...
	$query_apoyo = mysqli_prepare($connect,"SELECT AVG(CAST(a.temperatura AS DECIMAL(6,2))) as promedio, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, sensores as d 
																				WHERE a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ? AND b.id_asignado = ? AND  d.id_sensor = b.id_sensor
  ...
  $query_apoyo_2 = mysqli_prepare($connect,"SELECT AVG(CAST(a.temperatura AS DECIMAL(6,2))) as promedio, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, sensores as d 
																				WHERE a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ? AND b.id_asignado = ? AND  d.id_sensor = b.id_sensor
  ...
  $query_apoyo_3 = mysqli_prepare($connect,"SELECT MAX(CAST(a.temperatura AS DECIMAL(6,2))) as maximo, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, sensores as d 
                                            WHERE a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ? AND b.id_asignado = ? AND d.id_sensor = b.id_sensor GROUP BY d.nombre 
  ...
  $query_apoyo_4 = mysqli_prepare($connect,"SELECT MIN(CAST(a.temperatura AS DECIMAL(6,2))) as maximo, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, sensores as d 
                                            WHERE a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ? AND b.id_asignado = ? AND d.id_sensor = b.id_sensor GROUP BY d.nombre 
                                            order by maximo DESC limit 1 ");
  ...
  $query_apoyo_5 = mysqli_prepare($connect,"SELECT STD(CAST(a.temperatura AS DECIMAL(6,2))) as desviacion, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, 
  ...
  $query_apoyo_6 = mysqli_prepare($connect,"SELECT STD(CAST(a.temperatura AS DECIMAL(6,2))) as desviacion, d.nombre FROM refrigerador_datos_crudos as a, refrigerador_sensor as b, 
                                            bandeja as c, sensores as d WHERE a.id_refrigerador_sensor = b.id_refrigerador_sensor AND b.id_mapeo = ? AND b.id_asignado = ?
...
$query_13 = mysqli_prepare($connect,"SELECT ubicacion FROM images_informe_refrigeradores WHERE id_informe = ? AND tipo_imagen = 4");
