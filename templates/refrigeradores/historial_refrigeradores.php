<?php 
	...
	$consultar_historial = mysqli_prepare($connect,"SELECT b.nombre, b.apellido, a.mensaje_historial, a.tipo_historial, a.fecha_registro FROM 
																									persona as b, historial_refrigeradores as a WHERE a.id_usuario = b.id_usuario ORDER BY fecha_registro DESC");
	...
	$smarty->display("refrigeradores/historial_refrigeradores.tpl");
