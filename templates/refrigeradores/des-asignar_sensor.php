<?php 
	...
	$primer_filtro = mysqli_prepare($connect,"SELECT datos_crudos FROM refrigerador_sensor WHERE id_sensor = $id_sensor AND id_bandeja = $id_bandeja AND id_asignado = 																								$id_asignado");
	...
	if($datos_crudos != "" or $datos_crudos != NULL){
		echo "No";
	}else{
...
//////////////////////FIN DE INGRESO DEL BACKTRAKING///////////////////////////////////////////////////////////////////////////////////////////	
		...
		$quitar = mysqli_prepare($connect,"DELETE FROM refrigerador_sensor WHERE id_mapeo = ? AND id_asignado = ? AND id_bandeja = ? AND id_sensor = ?");
