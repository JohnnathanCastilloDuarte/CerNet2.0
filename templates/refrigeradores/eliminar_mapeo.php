...
//////////////////////FIN DE INGRESO DEL BACKTRAKING///////////////////////////////////////////////////////////////////////////////////////////
	...
	$primer_filtro = mysqli_prepare($connect, "SELECT id_mapeo FROM refrigerador_sensor WHERE id_mapeo = $id_mapeo");
	...
	if(mysqli_stmt_num_rows($id_mapeo_existente) > 0){
		echo "No";
	}else{
		
		$eliminar = mysqli_prepare($connect,"DELETE FROM refrigerador_mapeo WHERE id_mapeo = $id_mapeo");
