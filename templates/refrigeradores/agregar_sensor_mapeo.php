<?php 
		...
		$consultar = mysqli_prepare($connect,"SELECT id_refrigerador_sensor FROM refrigerador_sensor WHERE id_asignado = ? AND id_mapeo =  ? AND id_sensor = ?");
...
//////////////////////FIN DE INGRESO DEL BACKTRAKING///////////////////////////////////////////////////////////////////////////////////////////	
			...
			$ingresar = mysqli_prepare($connect,"INSERT INTO refrigerador_sensor (id_asignado, id_bandeja, id_sensor, id_mapeo, id_usuario)
																						VALUES (?,?,?,?,?) ");
