<div class="app-main__inner">
						...
						<tr>
							...
							<td>
								<div class="col-sm-12" style="text-align: center;">
									<a id="btn_editar_cliente" href="index.php?module={$modulo[4]}&page={$page[2]}&empresa={$empresa.id_empresa}" class="mb-2 mr-2 btn-icon btn-icon-only btn-shadow btn-outline-2x btn btn-outline-info">
	...
	<script type="text/javascript" src="design/js/empresa.js"></script> 