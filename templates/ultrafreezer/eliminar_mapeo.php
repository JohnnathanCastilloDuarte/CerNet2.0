...
*/
    ...
    $segundo_filtro = mysqli_prepare($connect, "SELECT id_mapeo FROM ultrafreezer_sensor WHERE id_mapeo = $id_mapeo");
    ...
    if($id_mapeo_e){ 
      ...
      $primer_filtro = mysqli_prepare($connect, "SELECT id_mapeo FROM informe_ultrafreezer WHERE id_mapeo = $id_mapeo");
      ...
      if($id_mapeo_existente){
		...
		$eliminar = mysqli_prepare($connect,"DELETE FROM ultrafreezer_mapeo WHERE id_mapeo = $id_mapeo");
