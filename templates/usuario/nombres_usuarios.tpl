		...
		<div class="col-sm-5">
			<div class="card">
				<div class="card-header">
					...
					{foreach from=$array_persona item=persona_array}
					{if file_exists($persona_array.imagen_usuario)}
					{$imagen_encontrada = $persona_array.imagen_usuario }
					{else}
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-sm-6">
								{$alerta_1}
								<label>Usuario:</label>
								<input type="text" name="usuario" class="form-control" value="{$persona_array.usuario}">
							</div>
							<div class="col-sm-6">
								<label>Empresa:</label>
						...
						{$checked1="checked"}
						{/if}
						{if $persona_array.estado == "Desvinculado"}
						{$checked2="checked"}
						{/if}
						{if $persona_array.estado == "Con licencia"}
						{$checked3="checked"}
						{/if}
						{if $persona_array.estado == "Vacaciones"}
						{$checked4 = "checked"}
						{/if}
						...
						<div class="row">
							...
							<div class="col-sm-3" style="text-align:center;">
								<div class="custom-radio custom-control">
									<input type="radio" id="exampleCustomRadio1" name="estado_usuario" class="custom-control-input" value="Activo" {$checked1}>
									<label class="custom-control-label" for="exampleCustomRadio1">Activo</label>
								</div>
							</div>
							<div class="col-sm-3" style="text-align:center;">					
								<div class="custom-radio custom-control">
									<input type="radio" id="exampleCustomRadio2" name="estado_usuario" class="custom-control-input" value="Desvinculado" {$checked2}>
									<label class="custom-control-label" for="exampleCustomRadio2">Desvinculado</label>	
								</div>
							</div>
							<div class="col-sm-3" style="text-align:center;">					
								<div class="custom-radio custom-control">
									<input type="radio" id="exampleCustomRadio3" name="estado_usuario" class="custom-control-input" value="Con licencia" {$checked3}>
									<label class="custom-control-label" for="exampleCustomRadio3">Con licencia</label>	
								</div>
							</div>
							<div class="col-sm-3" style="text-align:center;">					
								<div class="custom-radio custom-control">
									<input type="radio" id="exampleCustomRadio4" name="estado_usuario" class="custom-control-input" value="Vacaciones" {$checked4}>
