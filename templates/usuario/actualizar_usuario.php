...
telefono = ?, estado= ?, pais = ?, numero_identificacion = ?, id_empresa = ?, imagen_usuario = ?, id_cargo = ? 
WHERE id_persona = ?");
mysqli_stmt_bind_param($actualizando_p, 'ssssssissi', $nombre_usuario, $apellido_usuario, 
                       $telefono_usuario, $estado_usuario, $pais_usuario, 
                       $identificacion_usuario, $id_empresa, $personalizado, $cargo_usuario, $id_persona);
