<?php 
	...
	include("../../config.ini.php");
		...
		$listar = mysqli_prepare($connect,"SELECT a.id_estufaeincubadora_sensor, a.datos_crudos, a.id_sensor,  a.fecha_registro, b.nombre, c.nombre, c.id_bandeja, a.posicion FROM estufaeincubadora_sensor as a, sensores as b , bandeja as c
		...
		mysqli_stmt_bind_result($listar, $id_estufaeincubadora_sensor, $datos_crudos, $id_sensor, $fecha_registro, $nombre_sensor, $nombre_bandeja, $id_bandeja, $posicion);
	...
	while($row = mysqli_stmt_fetch($listar)){
		...
		$json[]=array(
			'id_estufaeincubadora_sensor'=>$id_estufaeincubadora_sensor,
			'id_sensor'=>$id_sensor,
