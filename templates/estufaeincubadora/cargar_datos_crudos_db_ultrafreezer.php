<?php
    ...
    $consultar_colum_1 = mysqli_prepare($connect,"SELECT a.id_dato_crudo, a.columna, a.time, a.temperatura FROM estufaeincubadora_datos_crudos as a, estufaeincubadora_sensor as b WHERE b.id_asignado = ? AND b.id_bandeja = ? AND b.id_mapeo = ? AND b.id_estufaeincubadora_sensor = a.id_estufaeincubadora_sensor");
