<?php 
		...
		$consultar = mysqli_prepare($connect,"SELECT id_estufaeincubadora_sensor FROM estufaeincubadora_sensor WHERE id_asignado = ? AND id_mapeo =  ? AND id_sensor = ?");
		...
		if($id_estufaeincubadora_sensor){
			echo "Existe";
...
*/			
			...
			$ingresar = mysqli_prepare($connect,"INSERT INTO estufaeincubadora_sensor (id_asignado, id_bandeja, id_sensor, id_mapeo, id_usuario)
																						VALUES (?,?,?,?,?) ");
