                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post" id="formulario_evidencias_graficas_flujo_laminar" enctype="multipart/form-data">
                                    <input type="hidden" name="id_asignado_graficas" value="{$id_asignado_flujo_laminar}">
...
<script type="text/javascript" src="design/js/control_mapeo_flujo_laminar.js"></script>
