...
$direccion_camara_congelada = $_POST['direccion_camara_congelada'];
$area_camara_congelada = $_POST['area_camara_congelada'];
...
if($actualizar_item){
    $actualizar_camara_congelada = mysqli_prepare($connect,"UPDATE item_camara_congelada SET marca = ?, modelo = ?, ubicacion = ?,
    valor_seteado = ?, valor_maximo = ?, valor_minimo = ?, direccion = ?, area_interna = ? WHERE id_item_camara_congelada = ?");
    mysqli_stmt_bind_param($actualizar_camara_congelada, 'ssssssiss', $marca_camara_congelada, $modelo_camara_congelada, $ubicacion_camara_congelada, $valor_seteado_camara_congelada, $limite_minimo_camara_congelada, $limite_minimo_camara_congelada, $id_camara_congelada);
    mysqli_stmt_execute($actualizar_camara_congelada, $direccion_camara_congelada, $area_camara_congelada);
