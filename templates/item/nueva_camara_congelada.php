...
$insertando_camara_congelada = mysqli_prepare($connect,"INSERT INTO item_camara_congelada 
(id_item, marca, modelo, ubicacion, valor_seteado, valor_maximo, valor_minimo, direccion, area_interna) VALUES (?,?,?,?,?,?,?,?,?)");
mysqli_stmt_bind_param($insertando_camara_congelada, 'issssssss', $id_item, $marca_camara_congelada, 
$modelo_camara_congelada, $ubicacion_camara_congelada, $valor_seteado_camara_congelada, $limite_maximo_camara_congelada,
                       $limite_minimo_camara_congelada,$direccion_camara_congelada,$area_camara_congelada);
