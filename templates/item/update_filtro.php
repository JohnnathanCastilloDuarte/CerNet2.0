...
if(isset($_GET['item'])){
  ...
  $consultar = mysqli_prepare($connect,"SELECT a.descripcion, b.id_filtro, b.marca, b.modelo, b.serie, b.cantidad_filtro, b.ubicacion, b.ubicado_en,
                                        b.tipo_filtro_dimension, c.nombre, c.id_empresa FROM item as a, item_filtro as b, empresa as c WHERE a.id_item = ? AND a.id_item = b.id_item AND a.id_empresa = c.id_empresa");
  ...
  mysqli_stmt_bind_result($consultar, $nombre_filtro, $id_filtro, $marca_fitro, $modelo_filtro, $serie_filtro, $cantidad_filtro, $ubicacion_filtro, $ubicado_en_filtro,
                                      $tipo_filtro, $empresa_filtro, $id_empresa);
