        ...
        <div id="smartwizard2" class="forms-wizard-alt">
          ...
          <div class="form-wizard-content">
            <div id="step-12">
              <div class="form-row">
                <div class="col-sm-6">
                  <input type="hidden" id="id_item_automovil" value="{$automovil.id_automovil}">
                  <input type="hidden" id="id_item_2_automovil" value="{$automovil.id_item}">
                  <input type="hidden" id="empresa_automovil" value="{$automovil.id_empresa}">
