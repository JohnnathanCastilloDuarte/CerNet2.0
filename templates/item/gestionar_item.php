<?php 
	...
	//consultar item
$query = "SELECT a.id_item, b.nombre, a.nombre, c.nombre, b.id_item, a.estado FROM item as a,tipo_item as b,empresa as c 
...
mysqli_stmt_bind_result($query_execute, $id_item, $nombre_tipo, $nombre_item, $nombre_empresa, $id_tipo, $estado);
