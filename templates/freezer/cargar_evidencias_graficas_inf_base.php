...
include("../../config.ini.php");
  ...
  $imagen_1 = $_POST['imagen_1_freezer'];
  $imagen_2 = $_POST['imagen_2_freezer'];
...
$buscando = mysqli_prepare($connect,"SELECT ubicacion FROM images_informe_freezer WHERE id_informe = ?  AND tipo_imagen = 4 ORDER BY fecha_registro DESC limit 1");
...
if(mysqli_stmt_num_rows($buscando) == 0){
  ...
  $buscar_2 = mysqli_prepare($connect,"SELECT SUBSTR(ubicacion,-6,2) FROM images_informe_freezer WHERE id_informe = ?  AND tipo_imagen = 4 ORDER BY fecha_registro DESC limit 1");
  ...
  if($digito < 10){
	...
	$personalizado=$target_dir."Equipo_Freezer".$digito.".jpg";
