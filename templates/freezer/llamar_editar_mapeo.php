<?php 
	...
	$listar = mysqli_prepare($connect,"SELECT  nombre, fecha_inicio, hora_inicio, fecha_final, hora_final, 
													intervalo, humedad_minima, humedad_maxima, temperatura_minima, temperatura_maxima, valor_seteado_humedad, valor_seteado_temperatura, informe_base FROM freezer_mapeo WHERE id_mapeo = $id_mapeo");
	...
	mysqli_stmt_bind_result($listar,  $nombre, $fecha_inicio, $hora_inicio, $fecha_final, $hora_final, $intervalo, $humedad_minima, $humedad_maxima, $temperatura_minima, 
																		$temperatura_maxima, $valor_seteado_humedad, $valor_seteado_temperatura, $informe_base);
