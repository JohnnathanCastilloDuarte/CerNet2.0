<?php 
	include("../../config.ini.php");
		...
		$consultar = mysqli_prepare($connect,"SELECT ubicacion FROM images_informe_freezer WHERE id_informe = ? ");
		...
		$eliminar = mysqli_prepare($connect,"DELETE FROM informe_freezer WHERE id_informe_freezer = ?");
