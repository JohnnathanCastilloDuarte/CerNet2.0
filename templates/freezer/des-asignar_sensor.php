<?php 
	...
	$primer_filtro = mysqli_prepare($connect,"SELECT datos_crudos FROM freezer_sensor WHERE id_sensor = $id_sensor AND id_bandeja = $id_bandeja AND id_asignado = 																								$id_asignado");
...
//////////////////////FIN DE INGRESO DEL BACKTRAKING///////////////////////////////////////////////////////////////////////////////////////////	
		...
		$quitar = mysqli_prepare($connect,"DELETE FROM freezer_sensor WHERE id_mapeo = ? AND id_asignado = ? AND id_bandeja = ? AND id_sensor = ?");
