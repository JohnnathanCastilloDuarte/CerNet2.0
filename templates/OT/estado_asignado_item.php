<?php 
	...
	$mensaje = "Ha asignado un item: ".$nombre_item." a el servicio: ".$nombre_servicio." de la OT: ".$ot;
	$tipo_historial = 1;
	...
	$update = mysqli_prepare($connect,"UPDATE item_asignado SET estado = 1 WHERE id_asignado = $id_asignado");
