...
$consultar = mysqli_prepare($connect,"SELECT a.id_numot, a.numot ,a.id_usuario_asignado, c.nombre, c.apellido, a.id_empresa, a.fecha_creacion, a.fecha_asignacion, b.nombre, a.cantidad_informes, d.nombre, e.departamento FROM numot as a, empresa as b, persona as c, cargo as d, departamento as e WHERE a.id_empresa = b.id_empresa AND numot = ? AND a.id_usuario_asignado = c.id_usuario AND c.id_cargo = d.id_cargo AND d.id_departamento = e.id; ");
