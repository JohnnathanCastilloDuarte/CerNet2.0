...
if(isset($_POST['empezar']))
{
  ...
  $existe_usuario="SELECT A.id_usuario, A.usuario, B.nombre, B.cargo FROM usuario AS A, persona AS B WHERE A.usuario=? AND password=? AND A.id_usuario=B.id_usuario";
  ...
  mysqli_stmt_bind_result($conecto,$id_usuario_online,$usuario_online,$nombre_usuario_online,$cargo_usuario_online);
