...
$pdf->writeHTMLCell(190, 5, 10, '', '<span>PERSONAS QUE HAN FIRMADO</span>', 1, 1, 0, true, 'C', true);
...
$pdf->writeHTMLCell(60, 5, 140, '', $fecha_firma , 1, 1, 0, true, 'C', true); 
  
$contador ++; 

}

$pdf->Output('Quienes han firmado.pdf', 'I');
